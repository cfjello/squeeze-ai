...
| `V13ImportAssignInlineNode` | *(no fields)* | `import_assign_inline` (`_`) |
...
`V13ImportAssignNode.LHS` is `*V13AssignLHSNode` (named import) or `*V13ImportAssignInlineNode` (wildcard `_` import).  
